...
PATIENTS = {
    "سرير 14 — مريض #014": {
        "braden": 13, "الحالة": "تحذير", "لون_الحالة": "badge-red",
    ...
    "سرير 09 — مريض #009": {
        "braden": 16, "الحالة": "مراقبة", "لون_الحالة": "badge-amber",
    ...
    "سرير 22 — مريض #022": {
        "braden": 19, "الحالة": "مستقر", "لون_الحالة": "badge-green",
...
for col, val, lbl in [
    ...
    (c2, p["الحالة"], "الحالة العامة"),
    (c3, p["منطقة_حرجة"], "المنطقة الأكثر تأثرًا"),
    (c4, p["زمن_آخر_تقليب"], "الزمن منذ آخر تقليب"),
]:
...
# ----------------------------------------------------------------------------
# 3. لوحة التنبؤ المبكر
# ----------------------------------------------------------------------------
card_start("لوحة التنبؤ المبكر", "⚡", "section-accent-amber")
if p["دقائق_للتنبيه"] is not None:
    ...
    st.caption("التنبؤ مبني على نقطة عجز فردية لكل منطقة تحدَّد عند إدخال بيانات المريض، لا على عتبة موحدة لجميع الأجسام.")
else:
    st.success("لا توجد مناطق تُظهر اتجاهًا تصاعديًا مقلقًا حاليًا.")
card_end()
